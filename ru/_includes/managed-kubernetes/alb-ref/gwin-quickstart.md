...
1. [Создайте сервисный аккаунт](../../../iam/operations/sa/create.md), от имени которого контроллер будет создавать ресурсы {{ alb-name }}, и [назначьте ему роли](../../../iam/operations/sa/assign-role-for-sa.md) на каталог:
   ...
   * [certificate-manager.certificates.downloader](../../../certificate-manager/security/index.md#certificate-manager-certificates-downloader) — для использования облачных сертификатов, добавленных в сервис [{{ certificate-manager-full-name }}](../../../certificate-manager/).
